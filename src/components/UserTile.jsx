  ...
  return (
    <div className='flex mb-1 rounded-md max-w-96 justify-between items-center border border-black'>
        ...
        <div className='flex m-2 items-center gap-2'> 
            <button className=' px-2 cursor-pointer hover:scale-110 transition-all border border-gray-600 rounded-lg'>Edit</button>
            <button className=' px-2 cursor-pointer hover:scale-110 transition-all border border-gray-600 rounded-lg'>Delete</button>
        </div>
    </div>
  )
}
